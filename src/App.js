...
function App() {  
  ...
  useEffect(() => {
    ...
    createTable('Data', 'ID INTEGER PRIMARY KEY AUTOINCREMENT, UserID INTEGER, Date VARCHAR(20),Heure VARCHAR(20), pollution25 INTEGER,pollution10 INTENGER, FOREIGN KEY(UserID) REFERENCES Users(ID)')
  },[]);
